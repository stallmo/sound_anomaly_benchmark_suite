...
Usage::
    ...
    from audio_processing.download.registry import DATASET_REGISTRY, get_dataset_info
...
from audio_processing.download.mimii import MimiiDownloader, MimiiPreprocessor
from audio_processing.download.mimii_due import MimiiDueDownloader, MimiiDuePreprocessor
from audio_processing.download.protocol import DatasetInfo
from audio_processing.download.respiratory_sound_database import (
