...
Usage::
    ...
    from audio_processing.utilities.data import ensure_data
...
from audio_processing.download.registry import DATASET_REGISTRY
from audio_processing.utilities.paths import effective_data_dir, entity_dir
